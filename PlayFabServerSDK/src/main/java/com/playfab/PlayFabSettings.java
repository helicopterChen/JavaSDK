...
public class PlayFabSettings {
    public static String SdkVersion = "0.78.181001";
    public static String BuildIdentifier = "jbuild_javasdk__sdk-slave2016-1_2";
    public static String SdkVersionString = "JavaSDK-0.78.181001";
